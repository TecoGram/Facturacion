...
describe('responseFormatter', function() {
  describe('formatFindVentas', function() {
    it(
      "Recibe un array de objetos con campo 'total' y formatea este campo" +
        ' para que solo tenga 2 numeros decimales.',
      function() {
        const arr = [
  ...
  describe('verVenta', function() {
    ...
    it('devuelve nombres de paciente y medico cuando se trata de una factura examen', function() {
