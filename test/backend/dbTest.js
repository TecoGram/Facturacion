...
describe('metodos de dbAdmin.js', function() {
  ...
  describe('insertarProducto', function() {
    it('persiste varios productos en la base encadenando con promise', function(
      done
    ) {
      db
        .insertarProducto('fsers4', 'producto Á', 'TECO', 9.99, 14.99, true)
        .then(function(ids) {
  ...
  describe('insertarCliente', function() {
    it('persiste varios clientes en la base encadenando con promise', function(
      done
    ) {
      db
        .insertarCliente(
  ...
  describe('findClientes', function() {
    it('retorna un array con todos los clientes existentes si se le pasa un string vacio', function(
      done
    ) {
    ...
    it('puede buscar clientes por nombre, si se le pasa un string no vacio como argumento', function(
      done
    ) {
    ...
    it('puede buscar clientes por nombre, sin tener que escribir las tildes', function(
      done
    ) {
  ...
  describe('findMedicos', function() {
    it('retorna un array con todos los medicos existentes si se le pasa un string vacio', function(
      done
    ) {
    ...
    it('puede buscar clientes por nombre, sin tener que escribir tildes', function(
      done
    ) {
  ...
  describe('insertarVentaExamen', function() {
    ...
    it('persiste una nueva venta en la base y agrega las unidades vendidas a la base', function(
      done
    ) {
      db
        .insertarVentaExamen(
  ...
  describe('insertarVenta', function() {
    ...
    it('No se permite borrar un cliente que tenga una factura asociada', function(
      done
    ) {
  ...
  describe('findVentas', function() {
    it('devuelve las ultimas ventas si se le pasa un string vacio', function(
      done
    ) {
      db
        .findVentas('', 0)
    ...
    it('devuelve las ultimas ventas cuyo nombre de cliente coincide con el string pasado como argumento', function(
      done
    ) {
      db
        .findVentas('Juan P', 0)
    ...
    it('encuentra ventas por cliente sin tener que escribir tildes', function(
      done
    ) {
      db
        .findVentas('perez', 0)
    ...
    it('devuelve array vacio si no encuentra ventas con ese cliente', function(
      done
    ) {
  ...
  describe('findVentasExamen', function() {
    it('devuelve las ultimas ventas de examen si se le pasa un string vacio', function(
      done
    ) {
      db
        .findVentas('', 1)
    ...
    it('devuelve las ultimas ventas examen cuyo nombre de cliente coincide con el string pasado como argumento', function(
      done
    ) {
      db
        .findVentas('Juan P', 1)
    ...
    it('devuelve las ultimas ventas examen cuyo nombre de paciente coincide con el string pasado como argumento', function(
      done
    ) {
      db
        .findVentas('Fabri', 1)
    ...
    it('encuentra ventas por paciente sin tener que escribir tildes', function(
      done
    ) {
      db
        .findVentas('encarnacion', 1)
        .then(function(results) {
          results.length.should.be.equal(1);
    ...
    it('devuelve array vacio si no encuentra ventas examen con ese paciente', function(
      done
    ) {
  ...
  describe('getFacturaData', function() {
    it('busca en la base de datos la fila de la venta, y los productos vendidos', function(
      done
    ) {
      const { codigo, empresa, ruc, subtotal } = ventaInsertada;

      db
        .getFacturaData(codigo, empresa, 0) //datos del test anterior 'insertarVenta'
        .then(function(resp) {
    ...
    it('busca en la base de datos la fila de la venta examen, y los productos vendidos', function(
      done
    ) {
      const { codigo, empresa, subtotal } = ventaExInsertada;

      db
        .getFacturaData(codigo, empresa, 1) //datos del test anterior 'insertarVentaExamen'
        .then(function(resp) {
    ...
    it('rechaza la promesa si no encuentra la factura', function(done) {
      db
        .getFacturaData('2016-11-03', 'VER', 0) //inexistente
  ...
  describe('updateVenta', function() {
    ...
    it('actualiza una venta y las unidades vendidas en la base', function(
      done
    ) {
      db
        .updateVenta(
  ...
  describe('deleteVenta', function() {
    it('borra una venta de la db y todas las unidades asociadas', function(
      done
    ) {
      db
        .getFacturablesVenta(ventaInsertada.codigo, ventaInsertada.empresa)
        .then(function(rows) {
    ...
    it('borra una venta examen de la db y todas las unidades asociadas', function(
      done
    ) {
      const { codigo, empresa } = ventaExInsertada;
      db
        .getFacturablesVenta(codigo, empresa)
        .then(function(rows) {
  ...
  describe('updateCliente', function() {
    ...
    it('retorna 0 en el callback si no encuentra un cliente a actualizar', function(
      done
    ) {
      const wrongArgs = [...updateArgs];
      wrongArgs[0] = '999333';
  ...
  describe('deleteCliente', function() {
    it('elimina un cliente de la base de datos, si no tiene facturas', function(
      done
    ) {
    ...
    it('retorna 0 en el callback si no encuentra un cliente a borrar', function(
      done
    ) {
