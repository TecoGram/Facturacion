...
describe('endpoints disponibles para el cliente', function() {
  describe('/cliente/new', function() {
    ...
    it('retorna 422 al ingresar cliente con un ruc ya existente', function(
      done
    ) {
      api
        .insertarCliente(
  ...
  describe('/medico/new', function() {
    ...
    it('retorna 500 al ingresar medico con un nombre ya existente', function(
      done
    ) {
      api
        .insertarMedico(
  ...
  describe('/medico/find', function() {
    ...
    it('retorna 404 si no encuentra medicos', function(done) {
      api.findMedicos('xyz').then(undefined, function(err) {
        const statusCode = err.status;
        const resp = err.response;
        statusCode.should.equal(404);
        resp.text.should.be.a('string');
  ...
  describe('/producto/new', function() {
    ...
    it('retorna 500 al ingresar producto con un nombre ya existente', function(
      done
    ) {
      api
        .insertarProducto('34tger5', mi_producto, 'TECO', 39.99, 49.99, true)
        .then(
          function() {
            throw unexpectedError;
          },
  ...
  describe('/producto/find', function() {
    ...
    it('puede limitar el numero de resultados con el segundo argumento', function(
      done
    ) {
      api
        .insertarProducto('34tger5', 'TGPx20x12', 'TECO', 39.99, 49.99, true)
        .then(function() {
  ...
  describe('/venta/new', function() {
    ...
    it('permite ingresar 2 facturas con mismo codigo pero diferente empresa', function(
      done
    ) {
      const ventaRowCopy = Object.assign({}, newVentaRow);
      ventaRowCopy.empresa = 'BIOCLED';
      api.insertarVenta(ventaRowCopy).then(
        function(resp) {
          const statusCode = resp.status;
          statusCode.should.equal(200);
          done();
    ...
    it('retorna 400 al ingresar datos duplicados', function(done) {
      api.insertarVenta(newVentaRow).then(
        function(resp) {
    ...
    it('no permite borrar productos facturados', function(done) {
      api.deleteProducto(1).then(done, function(err) {
        const statusCode = err.status;
        statusCode.should.equal(400);
        done();
      });
    ...
    it('no permite borrar clientes con facturas', function(done) {
      api.deleteCliente(cliente1.ruc).then(done, function(err) {
        const statusCode = err.status;
        statusCode.should.equal(400);
        done();
      });
  ...
  describe('/venta/update', function() {
    it('retorna 200 al ingresar datos correctos', function(done) {
      ...
      api.updateVenta(editedVenta).then(
        function(resp) {
          const statusCode = resp.status;
          statusCode.should.equal(200);
          done();
  ...
  describe('/venta/ver/:empresa/:codigo', function() {
    ...
    it("retorna json si el header 'Accept' es igual a 'application/json'", function(
      done
    ) {
      api
        .verVenta(newVentaRow.codigo, newVentaRow.empresa)
        .then(function(resp) {
    ...
    it('retorna 404 si la factura solicitada no existe', function(done) {
      request
        .get(`localhost:8192/venta/ver/CAPCOM/000123`)
  ...
  describe('/venta/delete', function() {
    it('retorna 200 al borrar factura exitosamente', function(done) {
      api
        .deleteVenta(newVentaRow.codigo, newVentaRow.empresa)
        .then(function(resp) {
          const statusCode = resp.status;
          statusCode.should.equal(200);
    ...
    it('retorna 404 al intentar borrar una factura no encontrada', function(
      done
    ) {
      api
        .deleteVenta('111', 'EA')
  ...
  describe('/venta_ex/delete', function() {
    ...
    it('retorna 404 al intentar borrar una factura de examen no encontrad0', function(
      done
    ) {
      api
        .deleteVenta('111', 'EA')
  ...
  describe('/producto/update', function() {
    ...
    it('retorna 404 al tratar de actualizar un producto inexistente', function(
      done
    ) {
  ...
  describe('/producto/delete', function() {
    ...
    it('retorna 404 al tratar de borrar un producto inexistente', function(
      done
    ) {
  ...
  describe('/cliente/update', function() {
    ...
    it('retorna 404 al tratar de actualizar un cliente inexistente', function(
      done
    ) {
  ...
  describe('/cliente/delete', function() {
    ...
    it('retorna 404 al tratar de borrar un cliente inexistente', function(
      done
    ) {
