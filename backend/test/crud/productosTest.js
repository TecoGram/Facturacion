...
describe('CRUD Productos dbAdmin.js', function() {
  ...
  describe('findProductos', function() {
    ...
    it('retorna un array con todos los productos si el input es string vacio', function(
      done
    ) {
    ...
    it('retorna un array con los productos cuyo nombre contenga el input string', function(
      done
    ) {
    ...
    it('puede buscar prodctos por nombre, sin tener que escribir las tildes ni mayusculas', function(
      done
    ) {
  ...
  describe('updateProducto', function() {
    ...
    it('puede modificar cualquier campo de Producto', function(done) {
      db
        .updateProducto(1, 'xxx', 'item B', 'NIPRO', 1.99, 3.99, false)
        .then(ids => {
          ids.should.equal(1);
